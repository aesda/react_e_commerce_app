const productData = {
    categories: [
        ...
        id: "singlets",
            category: "Singlets",
            image: "https://myer-media.com.au/wcsstore/MyerCatalogAssetStore/images/40/354/3642/302/8/122592820/122592820_1_240x309.webp?w=384&q=75",
            products: [
            {
                id: 1,
            ...
            },
            {
                ...
                rating: 5,
                imageAlt: "",
                description: "Rely on Regatta for dependable, versatile styles. Featuring a playful spot texture, this jumper is perfect for adding a pop of colour to your outfit. The solid hem adds a unique touch to the design, while the relaxed fit ensures comfort and versatility."
    ...
    id: "jackets",
            ...
            products: [
                {id: 1,
                    ...
                    imageAlt: "",
                    imageSrc: "https://www.myer.com.au/p/yarra-trail-emily-trench-in-stone"
                },
                {id: 2,
                    name: "HARPER DRESS",
                    href: "#",
